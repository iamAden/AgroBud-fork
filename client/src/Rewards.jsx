  ...
  return (
    <div className="reward">
      ...
      <div className="reward-header">
        ...
        <p id="referral-code">
          <strong>Referral Code:</strong> Ad87q1
        </p>
      </div>
            ...
            trigger={
              <button className="card-promo">
                ...
                <div className="require-coin">
                  <img
                    src={illustration1}
                    className="illustration-small-coin"
                  ></img>
                  <p>110</p>
                </div>
              </button>
                ...
                <div className="modalContainer">
                  ...
                  <div className="modalRight">
                    ...
                    <div className="off-header">
                      {" "}
                      10% OFF an any handcrafted beverage purchase{" "}
                    </div>
                    <div className="off-content">
                      <div className="dropdown-wrapper">
                        <button
                          className="dropdown-button"
                          onClick={toggleRedeemDropdown}
                        >
                          How to redeem
                        </button>
                        {isRedeemDropdownOpen && (
                          <div className="dropdown-content">
                            Tap on Redeem. You will receive the voucher code.
                            Please screenshot the code, once you tap OK, the
                            code will not show again
                          </div>
                        )}
                      </div>
                      ...
                      <div className="dropdown-wrapper">
                        ...
                        {isTermsDropdownOpen && (
                          <div className="dropdown-content">
                            <ul>
                              <li>
                                This voucher is valid until 24 December 2024,
                                11.59pm
                              </li>
                              <li>
                                Only valid for walk-in purchases at all brand
                                stores
                              </li>
                              <li>
                                Not valid with any other vouchers, promotions,
                                and discounts
                              </li>
                              <li>
                                The offer is not applicable to bottled drinks
                                and seasonal drinks
                              </li>
                            </ul>
                          </div>
